...
const Presentation = () => {
  return (
    <div className="w-full max-w-[1920px] min-h-20 box-border text-dark dark:text-light p-4 flex items-center justify-center">
      <div className="dark:bg-secondary bg-light max-lg:w-full w-1/2 p-4 min-h-30 flex flex-col items-center rounded-xl justify-center shadow-lg gap-4 relative overflow-hidden">
        ...
        <div className="flex gap-4 items-center z-10">
          <button className="px-4 py-2 dark:bg-dark bg-black text-light rounded-lg dark:hover:bg-dark/90 transition-colors hover:cursor-pointer">
            Download CV
          </button>
          <button className="px-4 py-2 border dark:border-dark border-black bg-white dark:bg-secondary dark:text-light rounded-lg dark:hover:bg-secondary/90 transition-colors hover:cursor-pointer ">
            Contact Me
          </button>
        </div>
      </div>
